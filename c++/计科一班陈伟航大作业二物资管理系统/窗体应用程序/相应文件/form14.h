...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button4->Click += gcnew System::EventHandler(this, &form14::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &form14::button3_Click);
			// 
			// button2
			// 
			...
			this->label29->Location = System::Drawing::Point(73, 65);
			...
			this->label28->Location = System::Drawing::Point(141, 13);
			...
			// textBox15
			// 
			this->textBox15->Location = System::Drawing::Point(211, 149);
			...
			// textBox14
			// 
			this->textBox14->Location = System::Drawing::Point(143, 149);
			...
			// textBox13
			// 
			this->textBox13->Location = System::Drawing::Point(75, 149);
			...
			// textBox12
			// 
			this->textBox12->Location = System::Drawing::Point(211, 119);
			...
			// textBox11
			// 
			this->textBox11->Location = System::Drawing::Point(143, 119);
			...
			// textBox10
			// 
			this->textBox10->Location = System::Drawing::Point(75, 117);
			...
			// textBox9
			// 
			this->textBox9->Location = System::Drawing::Point(143, 80);
			...
			// textBox8
			// 
			this->textBox8->Location = System::Drawing::Point(75, 80);
			...
			// textBox7
			// 
			this->textBox7->Location = System::Drawing::Point(143, 29);
			...
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(75, 29);
			...
			this->label12->Location = System::Drawing::Point(209, 65);
			...
			this->label11->Location = System::Drawing::Point(141, 65);
			...
			this->label10->Location = System::Drawing::Point(73, 13);
			...
			this->label9->Location = System::Drawing::Point(22, 149);
			...
			this->label8->Location = System::Drawing::Point(10, 117);
			...
			this->label7->Location = System::Drawing::Point(22, 83);
			...
			this->label6->Location = System::Drawing::Point(22, 29);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(303, 113);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(65, 43);
			this->button5->TabIndex = 14;
			this->button5->Text = L"修改";
			this->button5->UseVisualStyleBackColor = true;
			this->button5->Click += gcnew System::EventHandler(this, &form14::button5_Click);
			// 
			// form14
			// 
			...
			this->ClientSize = System::Drawing::Size(308, 267);
	...
	private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) 
			 {
				 ...
				 extern char*datetxt;
				 b.setnum(datedat);
				 char place[50]="",holder[50]="",responser[30]="";//
				 long phone=0;
				 int chairnum=0,desknum=0,micpnum=0,audionum=0;
				 daypart micppart=morning,audiopart=morning;
				 String^sactname=textBox1->Text;//
				 char*actname=(char*)(Marshal::StringToHGlobalAnsi(sactname)).ToPointer();//
				 a.showwithactname(datedat,actname,holder,place,responser,phone,
