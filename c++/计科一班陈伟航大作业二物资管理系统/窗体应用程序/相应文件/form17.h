...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(form17::typeid));
			...
			// textBox15
			// 
			this->textBox15->Location = System::Drawing::Point(211, 157);
			...
			// textBox14
			// 
			this->textBox14->Location = System::Drawing::Point(143, 157);
			...
			// textBox13
			// 
			this->textBox13->Location = System::Drawing::Point(75, 157);
			...
			// textBox12
			// 
			this->textBox12->Location = System::Drawing::Point(211, 127);
			...
			// textBox11
			// 
			this->textBox11->Location = System::Drawing::Point(143, 127);
			...
			// textBox10
			// 
			this->textBox10->Location = System::Drawing::Point(75, 125);
			...
			// textBox9
			// 
			this->textBox9->Location = System::Drawing::Point(143, 88);
			...
			// textBox8
			// 
			this->textBox8->Location = System::Drawing::Point(75, 88);
			...
			this->label7->Location = System::Drawing::Point(22, 91);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(297, 103);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(83, 229);
			this->button4->Name = L"button4";
			this->button4->Size = System::Drawing::Size(52, 26);
			this->button4->TabIndex = 8;
			this->button4->Text = L"开始";
			this->button4->UseVisualStyleBackColor = true;
			this->button4->Click += gcnew System::EventHandler(this, &form17::button4_Click);
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(223, 229);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(154, 229);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(9, 229);
			...
			this->ClientSize = System::Drawing::Size(302, 267);
...
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) 
		 {
			 ...
			 extern char*datetxt;
			 b.setnum(datedat);
			 char actname[50]="",place[50]="",responser[30]="";//
			 long phone=0;
			 int chairnum=0,desknum=0,micpnum=0,audionum=0;
			 daypart micppart=morning,audiopart=morning;
			 String^sholder=textBox2->Text;//
			 char*holder=(char*)(Marshal::StringToHGlobalAnsi(sholder)).ToPointer();//
			 a.showwithholder(datedat,actname,holder,place,responser,phone,
