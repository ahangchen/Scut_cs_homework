...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(form20::typeid));
			...
			this->button4->Click += gcnew System::EventHandler(this, &form20::button4_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &form20::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &form20::button2_Click);
			// 
			// button1
			// 
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(296, 103);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(60, 45);
			this->button5->TabIndex = 24;
			this->button5->Text = L"修改";
			this->button5->UseVisualStyleBackColor = true;
			this->button5->Click += gcnew System::EventHandler(this, &form20::button5_Click);
			// 
			// form20
			// 
...
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) 
		 {
			 ...
			 a.showwithphone(datedat,actname,holder,place,responser,phone,
