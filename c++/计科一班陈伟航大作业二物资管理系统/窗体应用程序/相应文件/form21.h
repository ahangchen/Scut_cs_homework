...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button3->Click += gcnew System::EventHandler(this, &form21::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &form21::button2_Click);
			// 
			// button1
			// 
			...
			// textBox9
			// 
			this->textBox9->Location = System::Drawing::Point(143, 91);
			...
			// textBox8
			// 
			this->textBox8->Location = System::Drawing::Point(75, 91);
			...
			this->label9->Location = System::Drawing::Point(22, 160);
			...
			this->label7->Location = System::Drawing::Point(22, 94);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(302, 108);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(63, 40);
			this->button5->TabIndex = 29;
			this->button5->Text = L"修改";
			this->button5->UseVisualStyleBackColor = true;
			this->button5->Click += gcnew System::EventHandler(this, &form21::button5_Click);
			// 
			// form21
			// 
...
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) 
		 {
			 ...
			 a.showwithchair(datedat,actname,holder,place,responser,phone,
