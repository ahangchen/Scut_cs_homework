...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^  resources = (gcnew System::ComponentModel::ComponentResourceManager(form22::typeid));
			...
			this->button3->Click += gcnew System::EventHandler(this, &form22::button3_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &form22::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &form22::button1_Click);
			// 
			// tabControl1
			// 
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(304, 101);
			this->button5->Name = L"button5";
			this->button5->Size = System::Drawing::Size(64, 47);
			this->button5->TabIndex = 34;
			this->button5->Text = L"修改";
			this->button5->UseVisualStyleBackColor = true;
			this->button5->Click += gcnew System::EventHandler(this, &form22::button5_Click);
			// 
			// form22
			// 
...
private: System::Void button4_Click(System::Object^  sender, System::EventArgs^  e) 
		 {
			 ...
			 a.showwithdesk(datedat,actname,holder,place,responser,phone,
